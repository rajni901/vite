...
const getHeaders = async (config, options) => {
    ...
    return new node_fetch_1.Headers(headers);
};
...
const sendRequest = async (options, url, body, formData, headers, onCancel) => {
    ...
    return new CancelablePromise_1.CancelablePromise(async (resolve, reject, onCancel) => {
        try {
            ...
            if (!onCancel.isCancelled) {
                const response = await (0, exports.sendRequest)(options, url, body, formData, headers, onCancel);
